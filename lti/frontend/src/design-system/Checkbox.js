  ...
  return (
    <article className='flex items-center gap-2'>
      <input
        ...
        required={required}
        type="checkbox"
        className={` ${isIncorrect ? 'border-red-500' : 'border-gray-300'}  peer bg-white appearance-none h-5 w-5 border rounded focus:ring-blue-500 focus:ring-2 text-blue-600 checked:bg-blue-500 checked:border-0`}
      />
