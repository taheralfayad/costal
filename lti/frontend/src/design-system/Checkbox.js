  ...
  return (
    <article className='flex items-center gap-2'>
      <input
        ...
        onChange={onChange}
        type="checkbox"
        className='peer relative appearance-none h-5 w-5 border rounded focus:ring-blue-500 focus:ring-2 text-emerald-600 checked:bg-emerald-500 checked:border-0'
      />
